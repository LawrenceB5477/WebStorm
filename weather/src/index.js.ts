...
function getCoords(location: string, callback: (res: any) => void): void {
   axios.get(`https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURI(location)}.json?access_token=pk.eyJ1Ijoia29kaWFjazU0NzciLCJhIjoiY2s0YXVpa3RyMDc3NjNmcW42YmQ1d2gxcyJ9.1xHVWk1T4mkc_Ma4ocejIQ&limit=1`)
      .then((resFirst) => {
