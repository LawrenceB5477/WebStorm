...
/** @class */
function () {
  function Model(eventDispatcher, syncer, attributes) {
  ...
  Model.prototype.set = function (state) {
  ...
  Model.prototype.fetch = function () {
    ...
    if (typeof id != "number") {
      ...
      this.syncer.fetch(this.get("id")).then(function (res) {
        _this.set(res.data);
      }).catch(function () {
        _this.trigger("error");
      });
  ...
  Model.prototype.save = function () {
    ...
    this.syncer.save(this.attributes.getAll()).then(function (res) {
      _this.trigger("save");
    }).catch(function () {
      _this.trigger("error");
    });
...
function () {
  ...
  Eventing.prototype.on = function (event, callback) {
  ...
  Eventing.prototype.trigger = function (event) {
    if (event in this.events) {
...
"use strict"; //you can make literals types in typescript, trippy
...
function () {
  ...
  Attributes.prototype.get = function (field) {
    return this.data[field];
  };

  Attributes.prototype.set = function (state) {
    this.data = __assign(__assign({}, this.data), state);
  };
...
function (_super) {
  ...
  function User(data) {
    return _super.call(this, new Eventing_1.Eventing(), new Sync_1.Sync(url), new Attributes_1.Attributes(data)) || this;
  }
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts","./Attributes":"src/models/Attributes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
